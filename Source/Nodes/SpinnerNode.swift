...
final class SpinnerNode: SKNode {
    static private let texture = SKTextureAtlas.game.textureNamed("spinner")
    static fileprivate let verticalTexture = SKTextureAtlas.game.textureNamed("spinner-vertical")
    static fileprivate let diagonalTexture = SKTextureAtlas.game.textureNamed("spinner-diagonal")
